...
import validateProfileInputs from "../../validation/profile";
import validateExperienceInputs from "../../validation/experience";
import validateEducationInputs from "../../validation/education";
...
router.post(
  ...
  (req, res) => {
    ...
    // Get fields
    const profileFields = {};
    profileFields.user = req.user.id; // include name avatar id
    ...
    Profile.findOne({ user: req.user.id }).then(profile => {
      if (profile) {
        ...
        // Create
        // Checking first if the handle exist
 ...
 *  @desciption     Delete user and profile
 *  @access         Private
 */
router.delete(
  "/",
